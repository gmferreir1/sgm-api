...
class Update {
  ...
  get messages() {
    return {
      "id.required": "Identificador da reserva não localizado",
      ...
      "attendant_register.required": "Informe o responsável do setor de cadastro",
      "attendant_reception.required": "Informe o responsável do setor da recepção",
    };
  }
}
